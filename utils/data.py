...
class WoofDataset(Dataset):
    def __init__(self, folder, img_size = (256, 256), aug=None):
        ...
        Args:
        -- folder: path to train or test folder
        -- img_size: size of img after resize
        -- aug: albumentations.Compose object with photo augmentations 
    ...
    def create_csv(self, data_dir):
        """
        Create csv file with class and path of each photo
        """
    ...
    def get_image(self, path):
        """
        Open and process image by its path
        """
